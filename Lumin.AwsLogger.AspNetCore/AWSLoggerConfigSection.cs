...
namespace Microsoft.Extensions.Configuration
{
    ...
    public class AWSLoggerConfigSection
    {
        ...
        /// <summary>
        /// Custom LogLevel Filters for <see cref="Lumin.AwsLogger.AspNetCore.AWSLoggerProvider"/>
        /// </summary>
        public IConfiguration LogLevels { get; set; } = null;


        /// <summary>
        /// Gets the <see cref="Lumin.AwsLogger.AspNetCore.AWSLogger.IncludeScopes"/> property. This determines if scopes - if they exist - are included in a log message.
        /// <para>
        /// The default is false.
        /// </para>
        /// </summary>
        public bool IncludeScopes { get; set; } = Lumin.AwsLogger.AspNetCore.Constants.IncludeScopesDefault;

        /// <summary>
        /// Gets the <see cref="Lumin.AwsLogger.AspNetCore.AWSLogger.IncludeLogLevel"/> property. This determines if log level is included in a log message.
        /// <para>
        /// The default is true.
        /// </para>
        /// </summary>
        public bool IncludeLogLevel { get; set; } = Lumin.AwsLogger.AspNetCore.Constants.IncludeLogLevelDefault;

        /// <summary>
        /// Gets the <see cref="Lumin.AwsLogger.AspNetCore.AWSLogger.IncludeCategory"/> property. This determines if category is included in a log message.
        /// <para>
        /// The default is true.
        /// </para>
        /// </summary>
        public bool IncludeCategory { get; set; } = Lumin.AwsLogger.AspNetCore.Constants.IncludeCategoryDefault;

        /// <summary>
        /// Gets the <see cref="Lumin.AwsLogger.AspNetCore.AWSLogger.IncludeEventId"/> property. This determines if event id is included in a log message.
        /// <para>
        /// The default is false.
        /// </para>
        /// </summary>
        public bool IncludeEventId { get; set; } = Lumin.AwsLogger.AspNetCore.Constants.IncludeEventIdDefault;

        /// <summary>
        /// Gets the <see cref="Lumin.AwsLogger.AspNetCore.AWSLogger.IncludeNewline"/> property. This determines if a new line is added to the end of the log message.
        /// <para>
        /// The default is true.
        /// </para>
        /// </summary>
        public bool IncludeNewline { get; set; } = Lumin.AwsLogger.AspNetCore.Constants.IncludeNewlineDefault;

        /// <summary>
        /// Gets the <see cref="Lumin.AwsLogger.AspNetCore.AWSLogger.IncludeException"/> property. This determines if exceptions are included in a log message.
        /// <para>
        /// The default is false.
        /// </para>
        /// </summary>
        public bool IncludeException { get; set; } = Lumin.AwsLogger.AspNetCore.Constants.IncludeExceptionDefault;
